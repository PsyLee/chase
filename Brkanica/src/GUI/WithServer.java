...
public class WithServer extends JPanel implements Runnable {

	private BufferedImage image ;

    public WithServer(String filename) {
    	try {
    ...
    public void run() {
        ...
        WithServer panel = new WithServer("/gui_images/start.jpg");
        ...
        //dugme za brkanje
        final JRadioButton chase = new JRadioButton("<html><body><img src='" + WithServer.class.getResource("/gui_images/chase.png")+"' width=105 height=35>", true);
        ...
        //dugle za beganje
        final JRadioButton run = new JRadioButton("<html><body><img src='" + WithServer.class.getResource("/gui_images/run.png")+"' width=105 height=30>", false);
        ...
        chase.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                chase.setText("<html><body><img src='" + WithServer.class.getResource("/gui_images/chase_hover.png")+"' width=105 height=35>");
...
//            
            ...
            @Override
            public void mouseExited(MouseEvent e) {
                chase.setText("<html><body><img src='" + WithServer.class.getResource("/gui_images/chase.png")+"' width=105 height=35>");
//                info.setText("");
            }
        ...
        run.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                run.setText("<html><body><img src='" + WithServer.class.getResource("/gui_images/run_hover.png")+"' width=105 height=30>");
//                info.setText("<html>Start the server and start to play<br/>WARNING: port forward the router using port 27960 for TCP and UDP</html>");
//            
            }
            ...
            @Override
            public void mouseExited(MouseEvent e) {
                run.setText("<html><body><img src='" + WithServer.class.getResource("/gui_images/run.png")+"' width=105 height=30>");
//                info.setText("");
            }
        ...
        settings.setLocation(60, 120);
        settings.setSize(170, 100);
        settings.setIcon(zaLabela("/gui_images/settings.png", 170, 100));
        panel.add(settings);
        ...
        settings.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                settings.setIcon(zaLabela("/gui_images/settings_hover.png", 170, 100));
//                info.setText("<html>Start the server and start to play<br/>WARNING: port forward the router using port 27960 for TCP and UDP</html>");
//            
            }
...
//                info.setText("");
        ...
        connect.setLocation(240, 120);
        connect.setSize(180, 100);
        connect.setIcon(zaLabela("/gui_images/connect.png", 180, 100));
        panel.add(connect);
        ...
        connect.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (nick.getText().trim().length() == 0) {
                    ...
                    network.setIP("localhost");
                    network.connect();

                    if (network.moze == false) {
                        JOptionPane.showMessageDialog(ramka, "Can't connect to localhost", "Connecting error", JOptionPane.ERROR_MESSAGE);
                    } else {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                connect.setIcon(zaLabela("/gui_images/connect_hover.png", 180, 100));
//                info.setText("<html>Start the server and start to play<br/>WARNING: port forward the router using port 27960 for TCP and UDP</html>");
//            
            }
...
//                info.setText("");
    ...
    public String zaJButton(String src, int width, int height) {

        String html = "<html><body><img src='/" + src + "' width=128 height=128>";
    ...
    private static ImageIcon zaLabela(String path, int width, int height) {
        ...
        try {
            BufferedImage originalImage = ImageIO.read(WithServer.class.getResource(path));
            ...
            Logger.getLogger(WithServer.class.getName()).log(Level.SEVERE, null, ex);
        }
        return resizedicon;
    }
}
